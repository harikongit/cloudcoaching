...
import { GraduationCap, Clock, Calendar, DollarSign, Users, Award, Cloud, Menu, X, Filter, Search, CheckCircle } from 'lucide-react';
      ...
      <nav className="bg-[#1E3A8A] text-white sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <Link to="/bootcamps" className="text-[#10B981] font-medium">Bootcamps</Link>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-[#1E3A8A] border-t border-white/10 px-4 py-4 space-y-3">
            ...
            <Link to="/bootcamps" className="block text-[#10B981]" onClick={() => setMobileMenuOpen(false)}>Bootcamps</Link>
          </div>
        )}
      </nav>

      {/* Header */}
      <div className="bg-gradient-to-r from-[#10B981] to-[#1E3A8A] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
