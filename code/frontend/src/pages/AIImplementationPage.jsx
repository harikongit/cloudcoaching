...
import { Sparkles, Cloud, Menu, X, Bot, Zap, Target, Code, MessageSquare, Lightbulb, ArrowRight, CheckCircle, Play } from 'lucide-react';
...
Would you like me to explain any part of this configuration in detail?`);
  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6]">
      ...
      <nav className="bg-[#1E3A8A] text-white sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <Link to="/certifications" className="hover:text-[#10B981] transition-colors">Certifications</Link>
              <Link to="/ai-implementation" className="text-[#10B981] font-medium">AI Implementation</Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-[#1E3A8A] border-t border-white/10 px-4 py-4 space-y-3">
            ...
            <Link to="/certifications" className="block hover:text-[#10B981]" onClick={() => setMobileMenuOpen(false)}>Certifications</Link>
            <Link to="/ai-implementation" className="block text-[#10B981]" onClick={() => setMobileMenuOpen(false)}>AI Implementation</Link>
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-[#7B42BC] to-[#1E3A8A] text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
